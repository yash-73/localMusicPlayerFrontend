    ...
    const Register = ()=>{
        ...
        return (
            <div className="w-full min-h-screen flex flex-col items-center justify-center bg-white">
              <div className="sm:w-[480px] max-sm:w-full max-sm:h-screen bg-white border border-gray-200 flex flex-col items-center justify-between sm:p-12 max-sm:p-6">
                <div className="flex flex-col w-full items-center gap-8">
                  <h2 className="text-4xl font-bold text-black text-center">Create Profile</h2>
